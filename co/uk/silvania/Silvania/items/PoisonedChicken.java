...
public class PoisonedChicken extends ItemFood {
	
    private final int healAmount;
    private final float saturationModifier;
    private final boolean isWolfsFavoriteMeat;
	
	public PoisonedChicken(int id, int par2, float par3, boolean par4) {
		super(id, par2, par4);
    ...
    public Icon getIconFromDamage(int par1) {
        return Item.chickenCooked.getIcon(new ItemStack(Item.chickenCooked), 0);
    }
